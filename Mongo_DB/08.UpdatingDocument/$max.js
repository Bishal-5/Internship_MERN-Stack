...
db.products.updateOne({ _id: 1 }, { $max: { price: 699 } }) //MAX From Current Value
db.products.updateOne({ _id: 1 }, { $max: { price: 599 } }) // No Update 
db.products.updateOne({ _id: 1 }, { $max: { price: 799 } })

db.products.updateOne({ _id: 1 }, { $max: { price: 899, "spec.ram": 12 } })
